...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(291, 38);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(430, 60);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Bienvenido a la calculadora de integrales\r\n              ";
